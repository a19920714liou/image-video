package com.bjhit.video.codecs.io;

import static com.bjhit.video.codecs.decode.CAVLCReader.readU;
import static com.bjhit.video.codecs.decode.CAVLCReader.readZeroBitCount;
...
import com.bjhit.video.codecs.H264Const;
import com.bjhit.video.codecs.io.model.MBType;
...
import com.bjhit.video.common.io.VLC;
import com.bjhit.video.common.model.ColorSpace;
import com.bjhit.video.common.tools.MathUtil;

/**
 * 上下文自适应可变长编码
 * @description Non-CABAC H.264 symbols read/write routines
 * @project bjhit-video
 * @author guanxianchun
 * @Create 2015-2-11 下午3:41:22
 * @version 1.0
 */
public class CAVLC {
